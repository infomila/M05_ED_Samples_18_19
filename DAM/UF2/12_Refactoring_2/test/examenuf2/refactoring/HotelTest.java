...
public class HotelTest {
    ...
    public void testGetFacturacio() {
        ...
        nh.addEstansa(new Estansa(new HabitacioTriple(301),new Date(2018,3,25), new Date(2018,3,28),1, RegimEnum.ESMORZAR));
        nh.addEstansa(new Estansa(new HabitacioTriple(303),new Date(2018,3,23), new Date(2018,3,29),3, RegimEnum.ESMORZAR));
